                ...
                <div class="white-box">
                    ...
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="id_admin" maxlength="12" value="<?=$data1['id_user']?>" readonly> </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Nama Pasien</label>
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="nama" maxlength="35" value="<?=$data1['nama']?>"> </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12">Telepon Pasien</label>
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="telepon" maxlength="12" onkeypress="return hanyaAngka(event)"  value="<?=$data1['telepon']?>"> </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group text-center">
                            <button type="submit" name="submit" class="btn btn-success">Update Data Dokter</button>
                        </div>
                    </form>
                      <?php 
