    ...
    <div class="col-md-6 col-md-offset-3">
        <div class="white-box">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" maxlength="12" name="id_Pasien" value="<?=$data1['id_user']?>" readonly> </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input type="text" class="form-control" maxlength="12" onkeypress="return hanyaAngka(event)" name="telepon" value="<?=$data1['telepon']?>"> </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <button type="submit" name="submit" class="btn btn-info btn-block btn-lg">Update Data Pasien</button>
                </div>
            </form>
            <?php 
                           ...
                           if (in_array($ex, $ex_bole) == true) {
                                if ($ukuran < 2*MB) {
                                    ...
                                    if ($query) {
                                        ...
                                        $_SESSION['pesan_success'] = "Berhasil Merubah Data Pasien.";
                                        ?><script>
