<?php 
    ...
    if (trim(@$_SESSION['id_user']) && trim(@$_SESSION['role']) == "Apoteker") {
...
<head>
    ...
    <title><?=$nama_web?> Dashboard Apoteker</title>
    <!-- Bootstrap Core CSS -->
    ...
    <!-- color CSS -->
    <link href="<?=base_url('base/dashboard/')?>css/colors/purple.css" id="theme" rel="stylesheet">
                <!-- sweetalert -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                <div class="sidebar-head">
                    <h3><span class="fa-fw open-close"><i class="ti-close ti-menu"></i></span> <span class="hide-menu">APOTEKER</span></h3> </div>
                <ul class="nav" id="side-menu">
                    <li class="user-pro">
                        <a href="javascript:void" class="waves-effect"><img src="<?=base_url('base/')?>plugins/images/users/varun.jpg" alt="user-img" class="img-circle"> <span class="hide-menu"> <?=$_SESSION['nama']?></span>
                        </a>
                    </li>
                    <li> <a href="obatpasien.php" class="waves-effect"><i class="mdi mdi-calendar-plus fa-fw" data-icon="v"></i> <span class="hide-menu"> Cek Obat Pasien</a>
                    </li>
                    <li> <a href="kelola.php" class="waves-effect"><i class="mdi mdi-history fa-fw" data-icon="v"></i> <span class="hide-menu"> Kelola Obat</a>
                    </li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 alert alert-info">
                        <h4 class="page-title ">Anda Login Sebagai Apoteker <span class="pull-right"><a style="color: #fff;" href="">Kembali Ke Website</a></span></h4> 
                    </div>
                </div>
    <?php 
}else{
